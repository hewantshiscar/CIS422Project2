...
def equal_q_answer(user, q_num, matches):
...
def equal_or_higher(user, q_num, matches):
...
def equal_or_lower(user, q_num, matches):
...
# 	current_matches = pref_check()
# 	compat(current_matches)
